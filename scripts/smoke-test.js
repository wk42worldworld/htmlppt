...
assert.match(appJs, /canvasSnapGuideKey/);
assert.match(appJs, /snapCandidates: null/);
...
assert.match(appJs, /drag\.snapCandidates = canvasSnapCandidates/);
assert.match(appJs, /if \(key === canvasSnapGuideKey\) return/);
